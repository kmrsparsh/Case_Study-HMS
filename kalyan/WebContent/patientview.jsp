 ...
 %>
    <body>
        <div class="topnav">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                  ...
                  <a class="active" href="patientview.jsp">Patient View</a>
        ...
        <center>
            <br>
            <h2>Patient View</h2>
            <form method = "POST" action = "PatientViewServlet" class="pure-form pure-form-aligned">  
                <fieldset>
                    <div class="pure-control-group">
                        <label for="aligned-name">Patient Id</label>
                        <input type="number" id="aligned-name" name="patientid" placeholder= "Patient Id" min="0" value=${ pid } required/>
                    </div>
            ...
            <form method = "POST" action = "PatientViewServlet" class="pure-form pure-form-aligned">  
                <fieldset>
                    ...
                    <div class="pure-control-group">
                        ...
                        <input type="text" id="aligned-name" name="patientname" readonly placeholder="Patient Name" required onkeypress="return false;" value=${ pname }  >
                    </div>
                    <div class="pure-control-group">
                        <label for="aligned-name">Patient Age</label>
                        <input type="number" id="aligned-name" name="patientage" readonly placeholder="Patient Age" onkeypress="return false;" required value=${ page } >
                    </div>
                    <div class="pure-control-group">
