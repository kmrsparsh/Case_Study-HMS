 ...
 %>>
    <body>
        ...
        <center>
            ...
            <form action="PatientDeleteServlet" method="POST" class="pure-form pure-form-aligned">  
                <fieldset>
                    <div class="pure-control-group">
                        <label for="aligned-name">Patient Id</label>
                        <input type="number" min="0" id="aligned-name" name="patientid" placeholder= "Patient Id" required value=${ pid } />
                    </div>
        ...
        <div>
        <center>
            <form method = "POST" action = "PatientDeleteServlet" class="pure-form pure-form-aligned">  
                <fieldset>
                    ...
                    <div class="pure-control-group">
                        ...
                        <input type="text" id="aligned-name" name="patientname" readonly placeholder="Patient Name" required onkeypress="return false;"required value=${ pname }  >
                    </div>
                    <div class="pure-control-group">
                        <label for="aligned-name">Patient Age</label>
                        <input type="number" id="aligned-name" name="patientage" readonly pattern="[0-9]{3}" placeholder="Patient Age" required onkeypress="return false;" required value=${ page } >
                    </div>
                    <div class="pure-control-group">
                    ...
                    <div class="pure-control-group">
                        <label for="aligned-admissiontype">Type of Bed</label>
                         <input style = "width: 14%;" type="text" name="dateofadmission" readonly id = "aligned-date" required onkeypress="return false;" value=${ ptypeofroom } >
                    </div>
                    <div class="pure-control-group">
                        <label for="aligned-address">Patient Address</label>
                        <input type="text" id="aligned-address" name="patientaddress" readonly placeholder="Patient Address" value= ${ paddress } >
                    </div>
                    <div class="pure-control-group">
